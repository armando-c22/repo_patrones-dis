...
class FileCourseRepository {
    ...
    writeData(courses) {
        return __awaiter(this, void 0, void 0, function* () {
            yield fs_1.promises.writeFile(DATA_FILE, JSON.stringify(courses, null, 2), 'utf-8');
        });
    }
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const courses = yield this.readData();
